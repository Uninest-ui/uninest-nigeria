...
export const INITIAL_USERS: UniNestUser[] = [
  ...
  },
  {
    ...
    name: 'Campus Prime Gadgets & Wears',
    university: 'Niger Delta University (NDU)',
    department: 'Commercial Vendor',
    avatarUrl: 'https://images.unsplash.com/photo-1556742049-0a67e557224f?w=150&auto=format&fit=crop&q=80',
    pictures: []
  }
];
...
export const INITIAL_STS_SAVINGS: STSSavingsAccount[] = [
  {
    ...
    stsAccountNumber: 'STS-9034-4429',
    university: 'Niger Delta University (NDU, Amassoma)',
    targetYear: '2027',
    targetGoalName: 'Final Year Project + Clearance + Graduation Gown',
    targetAmount: 200000,
    currentBalance: 75000,
    giftAccountBalance: 15000,
    giftBalance: 15000,
    walletBalance: 90000,
    stsPin: '1234',
    minSavingsLimit: 200,
    withdrawalDate: '2027-11-30',
    isActivated: true,
    frequency: 'monthly',
    ...
    giftsReceived: [
      {
        ...
        recipientEmail: 'student@campus.edu',
        recipientName: 'Tariere Ebimobowei',
        amount: 10000,
        occasion: 'Engineering Lab Project Support 💡',
        message: 'Keep making the Faculty of Engineering proud. Stay focused!',
        date: 'Aug 28, 2026'
      }
    ],
    transactions: [
      {
        ...
        amount: 25000,
        date: 'Aug 10, 2026',
        description: 'First semester initial sign-out savings stash'
      },
      {
        id: 'tx-2',
        type: 'deposit',
...
export const INITIAL_STS_ACCOUNTS: STSAccount[] = [
  {
    ...
    roomType: 'Self-Contain Apartment',
    budget: '₦180,000 / session',
    location: 'Amassoma, near NDU Main Gate',
    lodgeName: 'Peace Haven Luxury Student Villa (Flat #3)',
    status: 'active',
    pictures: [
...
export const INITIAL_ACADEMIC_ASSIST_REQUESTS: AcademicAssistRequest[] = [
  {
    ...
    studentName: 'Tariere Ebimobowei',
    phone: '08123456789',
    serviceType: 'Final Year Project (Ch 1-5)',
    topicOrCourse: 'Design & Soil Stabilization Analysis for Coastal Roads in the Niger Delta',
    department: 'Civil Engineering',
    institution: 'Niger Delta University (NDU)',
    deadline: '2026-10-15',
    additionalDetails: 'Need assistance with Chapter 3 (Methodology) and SPSS geotechnical variance calculation.',
    status: 'In Progress',
    createdAt: '2026-08-28',
  ...
  {
    id: 'acad-02',
    userEmail: 'amara.n@unilag.edu.ng',
    studentName: 'Ebiere Tonye',
    phone: '08099887766',
    serviceType: 'Plagiarism & Turnitin Reduction',
    topicOrCourse: 'Machine Learning Classification of Healthcare Datasets',
    department: 'Computer Science',
    institution: 'FUOTUOKE',
    deadline: '2026-09-10',
    additionalDetails: 'Current Turnitin similarity index is 38%, need it brought under 12% with AI scan clean.',
...
export const INITIAL_CROWDFUNDING_CAMPAIGNS: CrowdfundingCampaign[] = [
  {
    ...
    institution: 'Niger Delta University (NDU)',
    department: 'Civil Engineering',
    level: 'Final Year (500L)',
    matricNumber: 'NDU/2021/ENG/0491',
    title: 'Final Year Tuition Clearance & Faculty Sign-Out Project',
    category: 'School Fees & Tuition',
    targetAmount: 180000,
    currentRaised: 135000,
    story: 'I am in my final semester of Civil Engineering at NDU. My father suffered a stroke earlier this year and our family savings went into his medical emergency. Without clearing my tuition fees of ₦180,000 before exams next month, I cannot sit for the final degree examinations or defend my project. Any assistance to cross this finish line will change my entire family story.',
    hasSTSAccount: true,
    stsSavingsBalance: 45000,
    stsTargetGoal: 'Final Year Project + Clearance',
    stsProofNote: 'I have saved ₦45,000 through my UniNest STS account towards clearance. Need community support for the remaining balance.',
    stsProofUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=500&auto=format&fit=crop&q=80',
    proofDocumentName: 'NDU_Bursary_Outstanding_Invoice_2026.pdf',
    proofDocumentUrl: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?w=600&auto=format&fit=crop&q=80',
    proofDocumentType: 'School Fee Assessment Invoice',
    ...
    donations: [
      {
        id: 'don-1',
        campaignId: 'cf-001',
        donorName: 'Engr. Preye K.',
        donorEmail: 'preye.k@gmail.com',
        amount: 50000,
        paystackRef: 'pstk_ndu_992144',
        escrowStatus: 'held_in_escrow',
        message: 'Finish strong brother! We expect you in the engineering council.',
        date: '2026-08-29'
      },
      {
        id: 'don-2',
        campaignId: 'cf-001',
        donorName: 'Anonymous NDU Alum',
        amount: 35000,
        paystackRef: 'pstk_ndu_882019',
        escrowStatus: 'held_in_escrow',
        message: 'Rooting for your convocation day. God bless your family.',
        date: '2026-08-30',
        isAnonymous: true
      },
      {
        id: 'don-3',
        campaignId: 'cf-001',
        donorName: 'Dr. Tonye Allison',
        donorEmail: 't.allison@oilgas.ng',
        amount: 50000,
        paystackRef: 'pstk_ndu_771928',
        escrowStatus: 'held_in_escrow',
        message: 'Wishing your father a speedy recovery. Focus on your project.',
        date: '2026-09-01'
      }
    ],
    donorsCount: 3,
  ...
  {
    id: 'cf-002',
    studentEmail: 'chinelo.o@uniport.edu.ng',
    studentName: 'Chinelo Okonkwo',
    studentPhone: '08033221144',
    ...
    level: '400L Finalist',
    matricNumber: 'U2021/BMT/1109',
    title: 'Fabrication Components for Low-Cost Infant Incubator Final Year Project',
    category: 'Final Year Project',
    targetAmount: 120000,
    currentRaised: 85000,
    story: 'My final year research is on designing an affordable solar-hybrid infant radiant warmer for primary health centres in rural Niger Delta creek communities. I need ₦120,000 to purchase microcontroller boards, temperature sensors, DC heating elements, and acrylic casing.',
    hasSTSAccount: true,
    stsSavingsBalance: 28000,
    stsTargetGoal: 'Incubator Prototype Hardware',
    stsProofNote: 'Committed ₦28,000 from personal savings into UniNest STS escrow for components.',
    stsProofUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=500&auto=format&fit=crop&q=80',
    proofDocumentName: 'UNIPORT_HOD_Project_Approval_Letter.pdf',
    proofDocumentUrl: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=600&auto=format&fit=crop&q=80',
    proofDocumentType: 'Project Topic Approval Memo',
    bankName: 'Zenith Bank',
    accountNumber: '2119045512',
    accountName: 'Chinelo Chioma Okonkwo',
    status: 'approved',
    reviewedBy: 'admin@uninest.com',
    ...
    donations: [
      {
        id: 'don-4',
        campaignId: 'cf-002',
        donorName: 'Tech4Impact Africa',
        amount: 50000,
        paystackRef: 'pstk_uniport_10291',
        escrowStatus: 'held_in_escrow',
        message: 'Exceptional biomedical innovation. Keep building!',
        date: '2026-08-31'
      },
      {
        id: 'don-5',
        campaignId: 'cf-002',
        donorName: 'Chima & Friends (UNIPORT 2018 set)',
        amount: 35000,
        paystackRef: 'pstk_uniport_20392',
        escrowStatus: 'held_in_escrow',
        message: 'From Uniport Alum with pride.',
        date: '2026-09-02'
      }
    ],
    donorsCount: 2,
  ...
  {
    id: 'cf-003',
    studentEmail: 'grace.d@fuotuoke.edu.ng',
    studentName: 'Grace Danladi',
    studentPhone: '08166554433',
    ...
    level: '300L',
    matricNumber: 'FUO/2023/ECO/0882',
    title: 'Emergency Off-Campus Hostel Rent to Avoid Mid-Semester Eviction',
    category: 'Hostel & Accommodation',
    targetAmount: 140000,
    currentRaised: 0,
    story: 'My landlord at Otuoke New Site issued an ultimatum to vacate my room within 7 days because the shop where my sponsor operated burnt down in a market fire last month. I have nowhere else to stay during upcoming continuous assessment tests.',
    hasSTSAccount: true,
    stsSavingsBalance: 20000,
    stsTargetGoal: 'Rent Buffer Savings',
    stsProofNote: 'Locked ₦20,000 in STS. Landlord demand notice attached for admin verification.',
    stsProofUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=500&auto=format&fit=crop&q=80',
    proofDocumentName: 'Hostel_Tenancy_Eviction_Notice.jpg',
    proofDocumentUrl: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=600&auto=format&fit=crop&q=80',
    proofDocumentType: 'Landlord Notice to Quit & Tenancy Agreement',
    bankName: 'Guaranty Trust Bank (GTBank)',
    accountNumber: '0155239910',
    accountName: 'Grace Laraba Danladi',
  ...
  {
    id: 'cf-004',
    studentEmail: 'emmanuel.a@bmu.edu.ng',
    studentName: 'Emmanuel Adeleke',
    studentPhone: '08022119988',
    studentAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
    institution: 'Bayelsa Medical University (BMU)',
    department: 'Nursing Science',
    level: '200L',
    matricNumber: 'BMU/2024/NUR/0114',
    title: 'Urgent Clinical Kit & Scrub Clearance for Hospital Posting',
    category: 'Medical & Emergency',
    targetAmount: 95000,
    currentRaised: 95000,
    story: 'Nursing clinical rotations at the Federal Medical Centre Yenagoa begin next week. We are required to acquire the official diagnostic kits, medical scrubs, nursing footwear, and stethoscope.',
    hasSTSAccount: true,
    stsSavingsBalance: 35000,
    stsTargetGoal: 'Nursing Lab & Clinical Kit',
    stsProofNote: 'Paid ₦35,000 from STS. Need community assistance to complete kit fees.',
    stsProofUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=500&auto=format&fit=crop&q=80',
    proofDocumentName: 'BMU_Nursing_Clinical_Requirement_Notice.pdf',
    proofDocumentUrl: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&auto=format&fit=crop&q=80',
    proofDocumentType: 'Clinical Posting Mandate',
    bankName: 'United Bank for Africa (UBA)',
    accountNumber: '2088194432',
    accountName: 'Emmanuel Babatunde Adeleke',
    status: 'approved',
    reviewedBy: 'admin@uninest.com',
    ...
    donations: [
      {
        id: 'don-6',
        campaignId: 'cf-004',
        donorName: 'Florence Nightingale Foundation Nig.',
        amount: 60000,
        paystackRef: 'pstk_bmu_55102',
        escrowStatus: 'held_in_escrow',
        message: 'Proud to support our future healthcare heroes!',
        date: '2026-08-26'
      },
      {
        id: 'don-7',
        campaignId: 'cf-004',
        donorName: 'Dr. Stella E.',
        amount: 35000,
        paystackRef: 'pstk_bmu_99301',
        escrowStatus: 'held_in_escrow',
        message: 'Excel in your clinical posting at FMC.',
        date: '2026-08-27'
      }
    ],
    donorsCount: 2,
  ...
  {
    id: 'cf-005',
    studentEmail: 'samuel.b@rsu.edu.ng',
    studentName: 'Samuel Briggs',
    studentPhone: '08139988771',
    ...
    level: '500L Finalist',
    matricNumber: 'RSU/2021/CEN/0201',
    title: 'Replacement Motherboard & Screen for Final Year Coding Thesis',
    category: 'Laptop & Study Equipment',
    targetAmount: 110000,
    currentRaised: 110000,
    story: 'My development laptop suffered severe electrical surge during hostel power fluctuations. As a final year computer engineering student developing an IoT flood early-warning model for Bayelsa & Rivers waterways, I needed emergency funds to replace the logic board and screen.',
    hasSTSAccount: true,
    stsSavingsBalance: 30000,
    stsTargetGoal: 'Thesis Software Tools',
    stsProofNote: 'STS account verified. Technician quotation and HOD project letter provided.',
    stsProofUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=500&auto=format&fit=crop&q=80',
    proofDocumentName: 'RSU_Technician_Repair_Invoice.pdf',
    proofDocumentUrl: 'https://images.unsplash.com/photo-1597733336794-12d05021d510?w=600&auto=format&fit=crop&q=80',
    proofDocumentType: 'Repair Invoice & HOD Memo',
    bankName: 'First Bank of Nigeria',
    accountNumber: '3099881122',
    accountName: 'Samuel Tammy Briggs',
    status: 'paid_out',
    isPaidOut: true,
    paidOutAt: '2026-08-20',
    paidOutAmount: 110000,
    payoutProofUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80',
    payoutProofName: 'UniNest_Escrow_NIBSS_Disbursement_RSU_9941.pdf',
    payoutReference: 'ESCROW-PAY-RSU-2026-9041',
    payoutDestinationNote: 'Disbursed via UniNest Paystack Escrow directly to First Bank account. Laptop repaired and verified.',
    reviewedBy: 'admin@uninest.com',
    ...
    donations: [
      {
        id: 'don-8',
        campaignId: 'cf-005',
        donorName: 'Tech Port Harcourt Hub',
        amount: 80000,
        paystackRef: 'pstk_rsu_11094',
        escrowStatus: 'disbursed_to_beneficiary',
        message: 'Supporting young tech leaders in the Niger Delta.',
        date: '2026-08-16'
      },
      {
        id: 'don-9',
        campaignId: 'cf-005',
        donorName: 'Engr. D. Hart',
        amount: 30000,
        paystackRef: 'pstk_rsu_22910',
        escrowStatus: 'disbursed_to_beneficiary',
        message: 'Congratulations on completing your IoT prototype!',
        date: '2026-08-18'
      }
    ],
    donorsCount: 2,

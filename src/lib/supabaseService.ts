...
// 1. On signup, insert into profiles table: wallet_balance 33000, gift_balance 100000
  ...
  try {
    ...
    if (error) {
      ...
      if (retryError) {
        ...
        console.log('✅ Supabase profile saved with wallet_balance 33000, gift_balance 100000:', retryData);
        return retryData;
      }
    } else {
